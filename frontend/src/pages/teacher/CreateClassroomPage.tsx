...
export default function CreateClassroomPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-2xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <h1 className="text-xl font-semibold text-[#2F3437] mb-6">Crear Nueva Clase</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 border border-[#E0E0E0] rounded-md focus:ring-1 focus:ring-[#2F3437] focus:border-[#2F3437] outline-none resize-none text-sm text-[#2F3437]"
              rows={3}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#2F3437] text-white py-2.5 rounded-md text-sm font-medium hover:bg-[#454A4D] disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
          >
            {loading ? (
              <>
